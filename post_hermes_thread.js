...
// El hilo de 3 posts (Post 1 con vídeo, Post 2, Post 3)
const HILO_POSTS = [
    "Nous Research ha publicado una guía detallada para construir plugins de agentes personalizados en Hermes. Este sistema permite integrar de manera nativa herramientas personalizadas que los agentes de inteligencia artificial pueden invocar de manera autónoma. Abro hilo explicativo. 👇",
    "Para estructurar un módulo personalizado, la configuración reside en el archivo de configuración plugin.yaml dentro del directorio local de plugins de hermes. Este manifiesto define los metadatos básicos, las herramientas provistas y los ganchos opcionales de ejecución. 📁",
    "Las definiciones técnicas de los parámetros e instrucciones de las herramientas se realizan en el archivo schemas.py. Gracias a esto, el modelo de lenguaje interpreta cuándo y con qué variables debe invocar la herramienta, logrando total autonomía y compatibilidad con el protocolo de contexto de modelo. ⚙️"
];

const DELAY_MS = 10000; // Intervalo corto entre respuestas para la automatización

(async () => {
    try {
        console.log("==================================================");
        console.log("VAREGO - Publicador de Hilo de Guía Hermes con Vídeo");
                    ...
                    if (postNum === 1) {
                        ...
                        if (fs.existsSync(VIDEO_PATH)) {
                            ...
                            if (fileInputs.length > 0) {
                                ...
                                console.log("Video subido, esperando procesamiento multimedia (15 segundos)...");
                                await new Promise(r => setTimeout(r, 15000)); // Esperar procesamiento de X
                            } else {
                                console.log("Advertencia: No se encontró el selector del cargador de archivos.");
                            }
                        } else {
