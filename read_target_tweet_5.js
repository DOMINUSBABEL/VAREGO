...
(async () => {
    try {
        ...
        await page.goto('https://x.com/socialwithaayan/status/2062558194539626514', { waitUntil: 'networkidle2' });
        await new Promise(r => setTimeout(r, 6000));

        // Get body text
        const bodyText = await page.evaluate(() => document.body.innerText);
        fs.writeFileSync('tweet_body_5.txt', bodyText);
        console.log("Dumped body text to tweet_body_5.txt");
        ...
        const downloadDir = path.join(__dirname, 'downloaded_media_5');
        ...
        await browser.close();
        console.log("Finished target tweet 5 processing.");
    } catch (e) {
